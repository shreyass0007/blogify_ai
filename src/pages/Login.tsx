...
import { PenSquare, Mail, Lock, ArrowRight, Eye, EyeOff } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome back to BlogifyAI.",
      });
      navigate('/dashboard');
    } catch (error: any) {
      toast({
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-hero items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-primary-foreground/70 leading-relaxed">
            BlogifyAI helps you create compelling content that engages readers
            and grows your audience. Start writing your next masterpiece today.
          </p>
        </motion.div>
      </div>
    </div>
